...
public final class Reflection {
        ...
        for (final Field field : target.getDeclaredFields()) {
            if ((name == null || field.getName().equals(name)) && fieldType
                ...
                return new FieldAccessor<T>() {
                    ...
                    @Override @SuppressWarnings("unchecked") public T get(Object target) {
                        try {
     ...
     * @throws IllegalStateException If we cannot find this method.
     */
    public static MethodInvoker getTypedMethod(Class<?> clazz, String methodName,
        ...
        for (final Method method : clazz.getDeclaredMethods()) {
            if ((methodName == null || method.getName().equals(methodName)) && (returnType == null
                ...
                return new MethodInvoker() {
                    ...
                    @Override public Object invoke(Object target, Object... arguments) {
                        try {
                ...
                return new ConstructorInvoker() {
                    ...
                    @Override public Object invoke(Object... arguments) {
                        try {
                            ...
                            throw new RuntimeException("Cannot invoke constructor " + constructor,
                                e);
                        }
                    }
    ...
    public static Class<Object> getUntypedClass(String lookupName) {
        @SuppressWarnings({"rawtypes", "unchecked"}) Class<Object> clazz =
            (Class) getClass(lookupName);
        return clazz;
    }
