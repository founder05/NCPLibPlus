package me.marc_val_96.npclib.tinyprotocol;

import com.google.common.collect.Lists;
import com.google.common.collect.MapMaker;
import com.mojang.authlib.GameProfile;
import io.netty.channel.*;
import me.marc_val_96.npclib.tinyprotocol.Reflection.FieldAccessor;
import me.marc_val_96.npclib.tinyprotocol.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
    ...
    public TinyProtocol(final Plugin plugin) {
        ...
        try {
            ...
            // Damn you, late bind
            plugin.getLogger()
                .info("[TinyProtocol] Delaying server channel injection due to late bind.");
        ...
        endInitProtocol = new ChannelInitializer<Channel>() {
            ...
            @Override protected void initChannel(Channel channel) throws Exception {
                try {
                    ...
                    plugin.getLogger()
                        .log(Level.SEVERE, "Cannot inject incomming channel " + channel, e);
                }
            }
    ...
    private void registerBukkitEvents() {
        listener = new Listener() {
            ...
            @EventHandler public final void onPluginDisable(PluginDisableEvent e) {
    ...
    @SuppressWarnings("unchecked") private void registerChannelHandler() {
